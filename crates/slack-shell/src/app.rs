...
use crate::workspace_view::{WorkspaceView, WorkspaceViewEvent};
use slack_auth::sign_in_view::{SignInEvent, SignInView};
                    ...
                    Button::new("jump")
                        ...
                        .on_click(cx.listener(|_, _: &ClickEvent, window, cx| {
                            window.dispatch_action(
                                Box::new(slack_ui::actions::OpenQuickSwitcher),
                                cx,
                            );
                        })),
                )
...
pub fn init(cx: &mut App) {
    ...
    cx.set_menus(slack_ui::actions::menus());
    cx.on_action(|_: &slack_ui::actions::Quit, cx| cx.quit());
}
...
fn close_window(_: &slack_ui::actions::CloseWindow, window: &mut Window, _: &mut App) {
