...
use crate::direct_messages::{DirectMessagesEvent, DirectMessagesView};
use crate::history::History;
use crate::quick_switcher::{QuickSwitcher, QuickSwitcherEvent};
use crate::rail::{Pane, Rail, RailEvent};
use crate::sidebar::{SidebarEvent, SidebarView};
use slack_activity::activity_view::{ActivityEvent, ActivityView};
use slack_channel::channel_view::{ChannelEvent, ChannelView};
use slack_channel::thread_view::{ThreadEvent, ThreadView};
use slack_search::search_view::{SearchEvent, SearchView};
use slack_ui::actions::{
...
impl WorkspaceView {
    ...
    fn toggle_theme(&mut self, _: &ToggleTheme, window: &mut Window, cx: &mut Context<Self>) {
        slack_ui::theme::toggle(window, cx);
    }
